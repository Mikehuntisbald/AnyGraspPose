...
def main():
    ...
    for name in ('infer_lip_val_non_gt.py','score_val_non_gt.py','compare_fp_scorecard.py','benchmark_val_tracking.py','finish_rotation_alignment_pair.py'):
    ...
    try:
        ...
        infer(['control','alignment'],4)
        cmd=[sys.executable,'tools/compare_fp_scorecard.py','--rotation-alignment','--evaluation','fp='+str(a.fp_scored),'--out',str(r/'comparison')]
        ...
        for n in ('fp','residual','control','alignment'):
