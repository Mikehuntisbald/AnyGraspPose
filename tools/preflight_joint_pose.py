...
def main():
    ...
    if preserve:
        ...
        migration_adam=inherit_optimizer(optimizer,source)
    ...
    result=dict(passed=True,config_sha256=sha(a.config),source_sha256=c['reconstruction_only']['source_sha256'],
        batch=4,frames=40,pose_to_patch_xyz_depth_gradient_norms=pose_path_norms,loss=float(loss),seconds=seconds,first_seconds_including_compile=first_seconds,
