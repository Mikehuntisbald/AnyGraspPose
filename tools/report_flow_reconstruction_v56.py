...
def main():
    ...
    root=Path(args.root)
    tags=('baseline_v53','initial','final_on','final_no_feedback','final_no_transport','large_baseline','large_final')
    data={}
    for tag in tags:
        rows=[]
        for rank in range(8):
    ...
    result={};lines=['# V56 serial flow / JEPA prototype','',
