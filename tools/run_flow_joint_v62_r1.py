...
def main():
    ...
    root = Path('/mnt/why/dexycb_lip/unified_jepa_20260921/flow_joint_v62_r1')
    ...
    try:
        ...
        run('tests', [['-m','pytest','-q','tests/jepa/test_flow_reconstruction.py','tests/jepa/test_local_flow.py',
        ...
        for arm in ('control','strong'):
            cfg=f'configs/jepa/flow_joint_v62_r1_{arm}.yaml';out=root/arm/'seed42'
            for step in (2,200):
